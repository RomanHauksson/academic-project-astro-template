...
{/* <MyThumbnailSwitcher client:load>
  <ThumbnailPage thumbnail="bruh">
  This is some content
  </ThumbnailPage>
  <ThumbnailPage thumbnail="bruh 2">
  This is another set of content
  </ThumbnailPage>
</MyThumbnailSwitcher> */}

<MyThumbnailSwitcher client:load>
  <ThumbnailPage>
    <Image slot="thumbnail" src={dogsDiffc} />
    <p slot="content">The DiffC dog</p>
  </ThumbnailPage>
  <ThumbnailPage>
    <Image slot="thumbnail" src={dogsTrue} />
    <p slot="content">The true dog</p>
  </ThumbnailPage>
</MyThumbnailSwitcher>
