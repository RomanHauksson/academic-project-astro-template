...
Carousels are useful for situations where you'd like to display a collection of visuals, but you don't want it to take up that much space and you're okay with the reader not seeing every visual. I designed a carousel component specifically for this template because I wasn't satisfied with the existing carousel libraries. You can put arbitrary elements in each slide.
...
<Carousel>
  ...
  <CarouselSlide>
    Since this text isn't part of a component, it will be interpreted as **Markdown**.
  </CarouselSlide>
</Carousel>
