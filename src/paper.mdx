...
<Figure>
  <Comparison slot="figure" >
    <Picture slot="before" src={dogsDiffc} alt="Photo of two dogs running side-by-side in shallow water, lossily compressed using the DiffC algorithm" />
    <Picture slot="after" src={dogsTrue} alt="Original photo of two dogs running side-by-side in shallow water" />
  </Comparison>
