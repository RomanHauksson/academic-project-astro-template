...
<Figure>
  <Image slot="figure" src={transformer} alt="Diagram of the transformer deep learning architecture." invertInDarkMode />
...
import allstateSparsity from "../assets/allstate-sparsity.pdf";

<Figure>
  <Image slot="figure" src={allstateSparsity} alt="Impact of the sparsity-aware algorithm in XGBoost on the Allstate-10K dataset." invertInDarkMode />
